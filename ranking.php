        ...
        <div id="container">
            ...
            <div id="inside">
			   ...
			   do { ?>
				...
				<?php 
				   ...
				   do { ?>
				   <?php if($id < 7){ ?>
				   <div class="profiles" id="nombres_ultimos<?php if (empty($id)){ $id = 1;  }echo $id; ?>">
				  ...
				  <div style="left:500px; position:absolute; margin-top:-30px;">
            ...
            <div id="foot1">
                <div id="butons">
                    ...
                    <a href="javascript:history.back()"><div class="inn">Juega Beisbol</div></a>
