        ...
        <!--<script>
            $(document).ready(function () {
                ...
                $('.clear').click(function () {
                    if (pierde) {
                        runs = $('#carreras').attr('value');
                        alert(runs);
                        $("#ajax").load("ajax.php", { id: runs }, function() {
                            //alert("recibidos los datos por ajax" + runs);
                        });
                    }
                });
            });
            ...
            <div id="inside">
                ...
                <div id="all">
                    ...
                    <div id="botones">
                        ...
                        <input class="buttonP" type="button" value="" onClick="start()">
                        <input class="buttonS" type="button" value="" onClick="stop()">
                        <input class="clear" type="button" value="">
