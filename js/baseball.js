...
function stop() {
    ...
    $(".buttonP").attr("value", "");
    $(".buttonP").removeAttr("style", "background");
    ...
    $(".clear").click(function () {
        ...
        if (strike == 3) {
            ...
            if (out == 3) {
                ...
                pierde = true;
                //alert(carrera);
                $("#ajax").load("ajax.php", { id: carrera }, function () {
                    //alert("recibidos los datos por ajax" + idEdo);
                });
                $("#runs").attr('value', carrera);
                $("#carreras").attr('value', carrera);
                $(".buttonP, .clear").removeAttr("style", "background");
                $(".buttonP, .clear").removeAttr("value");
                //$(".buttonP").css("background", "url('/img/game/gris1.png') center no-repeat");
                $(".pierde, .nuevo").show();
        ...
        //$(".buttonP").attr("value", "START");
        $(this).attr("value", "");
        $(this).removeAttr("style", "background");
        //$(this).css("background", "url('/img/game/gris1.png') center no-repeat");
        $(this).attr("disabled", "disabled");
    });
});